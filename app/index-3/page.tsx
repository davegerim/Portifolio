              ...
              <div className="col-lg-4 offset-lg-1">
                ...
                <div className="d-flex flex-column gap-2 mt-9 position-relative z-1">
                  ...
                  <Link href="mailto:meisa.rosie@gmail.com">
                    ...
                    <span className="text-300 fs-6 ms-2">
                      meisa.rosie@gmail.com
                    </span>
                  </Link>
                  <Link href="#">
              ...
              <div className="col-lg-7 pt-lg-0 pt-8">
                <div id="about" className="hero-3 pe-lg-5 border-bottom pb-7">
                  ...
                  <h2 className="text-300 my-3">
                    ...
                    <span className="text-dark">
                      with Passion: Discover the Work
                    </span>{" "}
                    of Meisa
                  </h2>
                  <p className="mb-8">
                    Welcome to the creative world of Meisa Rosie, where words
                    are crafted into captivating stories and insightful content.
                    Explore her journey as an award-winning writer and discover
                    how she brings imagination to life through her unique voice
                            ...
                            <div className="card__inner rounded-4 border border-secondary-3 bg-white p-lg-5 p-md-4 p-3">
                              <div className="card__image-container rounded-0 zoom-img position-relative">
                                <img
                                  ...
                                  src="assets/imgs/home-page-3/typical/img-1.png"
                                  alt="zelio"
                                />
                                <Link
                                  href="@@link"
                                ...
                                <div className="card__title mb-0 mb-lg-2">
                                  ...
                                  <Link href="#">
                                    <p className="fs-3 text-dark">
                                      Novels: Echoes of the Past
                                    </p>
                                  </Link>
                                </div>
                                <p className="text-300 mb-lg-auto mb-md-4 mb-3">
                                  Set in a dystopian future, "Reflections of
                                  Tomorrow" is a thought-provoking novel that
                                  explores themes of identity, freedom, and
                                  resilience. Through its compelling storyline
                                  and well-drawn characters, the book invites
                                  readers to ponder the ethical dilemmas of
                          ...
                          <div className="card-custom pt-0" data-index={1}>
                            <div className="card__inner rounded-4 border border-secondary-3 bg-white p-lg-5 p-md-4 p-3">
                              <div className="card__image-container rounded-0 zoom-img position-relative">
                                <img
                                  className="card__image"
                                  src="assets/imgs/home-page-3/typical/img-2.png"
                                  alt="zelio"
                                />
                                <Link
                                  href="@@link"
                          ...
                          <div className="card-custom pt-0" data-index={2}>
                            <div className="card__inner rounded-4 border border-secondary-3 bg-white p-lg-5 p-md-4 p-3">
                              <div className="card__image-container rounded-0 zoom-img position-relative">
                                <img
                                  className="card__image"
                                  src="assets/imgs/home-page-3/typical/img-3.png"
                                  alt="zelio"
                                />
                                <Link
                                  href="@@link"
                  ...
                  <div className="card-services mb-3 pt-4">
                    <div className="card__inner rounded-4 border border-secondary-3 bg-white p-lg-4 p-md-4 p-3 d-flex">
                      ...
                      <div className="card__content px-md-4 px-3">
                        ...
                        <p className="text-300 mb-lg-auto mb-md-4 mb-3">
                          Whether you're looking for an immersive novel, a
                          captivating short story, or evocative poetry, I am
                          your go-to writer. With a deep understanding of
                          character development, plot structure, and lyrical
                          prose, I craft stories that resonate and inspire.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="card__inner rounded-4 border border-secondary-3 bg-white p-lg-4 p-md-4 p-3 d-flex">
                      ...
                      <div className="card__content px-md-4 px-3">
                        <div className="card__title mb-0 mb-lg-2">
                          <Link href="#">
                            <p className="fs-4 text-dark">
                              Articles, Blog Posts, and Website Content
                            </p>
                          </Link>
                        </div>
                        <p className="text-300 mb-lg-auto mb-md-4 mb-3">
                          Today's digital age, engaging content is crucial for
                          capturing your audience's attention. I specialize in
                          creating high-quality content that aligns with your
                    ...
                    <div className="card__inner rounded-4 border border-secondary-3 bg-white p-lg-4 p-md-4 p-3 d-flex">
                      ...
                      <div className="card__content px-md-4 px-3">
                        <div className="card__title mb-0 mb-lg-2">
                          <Link href="#">
                            <p className="fs-4 text-dark">
                              Precision Proofreading and Editing
                            </p>
                          </Link>
                        </div>
                        <p className="text-300 mb-lg-auto mb-md-4 mb-3">
                          Enhance your brand with compelling stories and
                          memorable content that resonates with your audience.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="card-services mb-3">
                    <div className="card__inner rounded-4 border border-secondary-3 bg-white p-lg-4 p-md-4 p-3 d-flex">
                      ...
                      <div className="card__content px-md-4 px-3">
                        ...
                        <p className="text-300 mb-lg-auto mb-md-4 mb-3">
                          Improve your online visibility with our SEO-focused
                          content, designed to rank higher and attract more
                          visitors.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="col-md-6 align-self-stretch h-100">
                      <div className="card-services rounded-4 border border-secondary-3 bg-white p-lg-5 p-md-4 p-3 h-100">
                        <div className="icon rounded-circle overflow-hidden d-inline-block">
                          <img
                            src="assets/imgs/home-page-3/education/icon-1.png"
                            alt="Education"
                          />
                        </div>
                        <p className="text-dark fs-5 mt-1 mb-2">
                          Certificates in Digital Content and SEO Writing
                        </p>
                        ...
                        <div className="icon rounded-circle overflow-hidden d-inline-block">
                          <img
                            src="assets/imgs/home-page-3/education/icon-2.png"
                            alt="Education"
                          />
                        </div>
                        <p className="text-dark fs-5 mt-1 mb-2">
                          Writing Workshops and Continuing Education
                        </p>
                        <ul className="d-flex gap-4 ps-3 border-bottom pb-2 mb-4">
                          <li>
                        ...
                        <div className="icon rounded-circle overflow-hidden d-inline-block">
                          <img
                            src="assets/imgs/home-page-3/education/icon-3.png"
                            alt="Education"
                          />
                        </div>
                        <p className="text-dark fs-5 mt-1 mb-2">
                        ...
                        <div className="position-relative h-100 align-self-stretch align-items-center">
                          <ul className="list-style-1 d-flex ps-3 flex-column mb-0">
                            <li className="position-relative z-1">
                              ...
                              <p className="mb-4">
                                Worked with various clients, including
                                magazines, websites, and publishing houses, to
                                produce high-quality content across multiple
                                genres.
                              </p>
                            </li>
                            <li className="position-relative z-1">
                              ...
                              <p className="mb-6">
                                Created engaging articles, blog posts, and
                                features for one of the leading literary
                                websites.
                              </p>
                            </li>
                            <li className="position-relative z-1">
                              ...
                              <p>
                                Overseeing the editorial process, providing
                                guidance, and ensuring the highest standards of
                                content.
                              </p>
                            </li>
                          </ul>
                ...
                <div id="blog" className="blog pt-70">
                  ...
                  <div className="position-relative pt-4">
                    <Swiper
                      {...swiperOptions2}
                      className="swiper slider-two pb-6 position-relative"
                    >
                        ...
                        <SwiperSlide>
                          <div className="card-services rounded-4 border border-secondary-3 bg-white p-lg-4 p-md-4 p-3 mb-3">
                            ...
                            <div className="d-flex align-items-center gap-5">
                              <div>
                                <p className="fs-26 text-dark">
                                  The Power of Storytelling: How to Create
                                  Engaging Narratives
                                </p>
                                <p className="mb-0">
                                  Storytelling is at the heart of human
                                  experience. In this post, I delve into the key
                                  elements that make a story compelling and
                                  share techniques to enhance your narrative
                                  skills.
                                </p>
                              </div>
                              <div className="image-right">
                                <img
                                  ...
                                  src="assets/imgs/home-page-3/blog/img-1.png"
                                  alt="zelio"
                                />
                              </div>
                            </div>
                          ...
                          <div className="card-services rounded-4 border border-secondary-3 bg-white p-lg-4 p-md-4 p-3">
                            <p className="fs-18 text-primary-3">
                              Author Insights
                            </p>
                            <div className="d-flex align-items-center gap-5">
                              <div>
                                ...
                                <p className="mb-0">
                                  Eery writer faces writer's block at some
                                  point. Here, I explore effective methods to
                                  overcome this common challenge and reignite
                                  your creative spark
                                </p>
                              </div>
                              <div className="image-right">
                                <img
                                  className="rounded-3 w-100 h-100"
                                  src="assets/imgs/home-page-3/blog/img-2.png"
                                  alt="zelio"
                                />
                              </div>
                            </div>
                          ...
                          <div className="card-services rounded-4 border border-secondary-3 bg-white p-lg-4 p-md-4 p-3">
                            ...
                            <div className="d-flex align-items-center gap-5">
                              <div>
                                ...
                                <p className="mb-0">
                                  Every writer faces writer's block at some
                                  point. Here, I explore effective methods to
                                  overcome this common challenge and reignite
                                  your creative spark
                                </p>
                ...
                <div
                  id="portfolio"
                  className="testimonials pt-60 border-bottom pb-80"
                >
                  <h3>Testimonials</h3>
                  <div className="position-relative pt-4">
                    <Swiper
                      {...swiperOptions}
                      className="swiper slider-one pb-3 position-relative"
                    >
                      <div className="swiper-wrapper">
                        <SwiperSlide>
                          <div className="testimonials-block pe-5">
                            <img
                              ...
                              src="assets/imgs/home-page-3/testimonials/author-1.png"
                              alt="avatar"
                            />
                            <p className="fs-5 text-dark">
                              "Meisa's writing is simply magical. She has the
                              ability to capture the essence of a story and
                              preset it in the most captivating way."
                            </p>
                            <div className="information ">
                              <p className="fs-6 text-primary-3">
                                John Doe,{" "}
                                <span className="text-300">Author</span>
                              </p>
                            </div>
                          </div>
                        </SwiperSlide>
                        <SwiperSlide>
                          <div className="testimonials-block pe-5">
                            <img
                              className="rounded-circle mb-2"
                              src="assets/imgs/home-page-3/testimonials/author-2.png"
                              alt="avatar"
                            />
                            <p className="fs-5 text-dark">
                              "Working with Meisa was a fantastic experience.
                              Her attention to detail and commitment to quality
                              are unparalleled."
                            </p>
                            <div className="information ">
                              <p className="fs-6 text-primary-3">
                                Jane Smith,{" "}
                                <span className="text-300">Editor</span>
                              </p>
                            </div>
                          </div>
                        </SwiperSlide>
                  ...
                  <div className="d-flex align-items-center gap-5 mt-4">
                    ...
                    <div className="d-flex flex-column gap-2 position-relative z-1">
                      <Link href="#">
                        ...
                        <span className="text-300 fs-6 ms-https://www.google.com/maps/place/1st+Ave.,+New+York,+NY,+Hoa+K%E1%BB%B3/@40.7630169,-73.9594939,17z/data=!4m6!3m5!1s0x89c258c29e084453:0x2bf768350d30b89e!8m2!3d40.7630169!4d-73.9594939!16zL20vMDV3Z2tm?entry=ttu&g_ep=EgoyMDI0MDkxNi4wIKXMDSoASAFQAw%3D%3D">
                          meisa.rosie
                        </span>
                      </Link>
                      <Link href="#">
