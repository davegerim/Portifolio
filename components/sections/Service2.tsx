                  ...
                  <div className="row g-4">
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <h6 className="my-3 fw-medium">
                          Web &amp; App Development
                        </h6>
                        <p className="fs-7 text-300 fw-regular">
                          Crafting responsive and user-friendly interfaces using
                          ...
                          Experienced in developing modern UIs with Mantine UI
                          and Tailwind CSS.
                        </p>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <p className="fs-7 text-300 fw-regular">
                          Designing and maintaining relational and
                          non-relational databases using{" "}
                          <span className="text-secondary-2">MySQL</span>,{" "}
                          <span className="text-secondary-2">PostgreSQL</span>,
                          and <span className="text-secondary-2">MongoDB</span>.
                          Capable of structuring optimized schemas and managing
                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <p className="fs-7 text-300 fw-regular">
                          Developing and integrating secure{" "}
                          <span className="text-secondary-2">RESTful APIs</span>{" "}
                          using{" "}
                          <span className="text-secondary-2">
                            Nest.js, Express.js, and Node.js
                          </span>{" "}
                          .Skilled in building robust, scalable backends and
                          custom endpoints.
                        </p>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <h6 className="my-3 fw-medium">Custom Web Apps</h6>
                        <p className="fs-7 text-300 fw-regular">
                          Built custom full-stack applications like Zuret Tour
                          using
                          <span className="text-secondary-2">
                            {" "}
                            React.js
                          </span>,{" "}
                          <span className="text-secondary-2">Nest.js</span>{" "}
                          handling both frontend user experience and backend
                          services.
                        </p>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <p className="fs-7 text-300 fw-regular">
                          Developed and customized themes, improved SEO, and
                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <h6 className="my-3 fw-medium">Project Leadership</h6>
                        <p className="fs-7 text-300 fw-regular">
                          Led and coordinated teams during internship and
                          project phases at{" "}
                          <span className="text-secondary-2">
                            {" "}
                            Herani Tech and INSA,
                          </span>{" "}
                          ensuring timely delivery, clear documentation, and
                          teamwork.
                        </p>
                      </div>
                    </div>
