              ...
              <div className="row align-items-end py-60">
                <div className="col-lg-5 ps-lg-5 text-lg-start text-center">
                  <div className="position-relative mb-lg-0 mb-5">
                    <img
                      src="assets/imgs/home-page-2/hero-1/people copy (2).png"
                      alt="zelio"
                    />
                ...
                <div className="col-lg-6 mx-lg-auto col-md-12">
                  <div className="p-lg-0 p-md-8 p-3">
                    ...
                    <p className="mb-6 text-secondary-2">
                      ...
                      <span className="text-secondary-2">Next</span>,{" "}
                      <span className="text-secondary-2">Nest</span>, and{" "}
                      <span className="text-secondary-2">Wordpress</span>
                      <span className="text-dark">
                    ...
                    <Link
                      href="assets/Full stack developer resume.pdf"
